...
class ReviewDf():
    ...
    def new(self):
        ...
        print(list(sumdf))
        sumdf.to_csv(os.path.join('com_cheese_api/resources/data', 'review_fin.csv'), index=False, encoding='utf-8-sig')
        return sumdf
...
#     # 결측값 제거 필요
    ...
    def df_split(data):
        ...
        review_train.to_csv(os.path.join('com_cheese_api/resources/data', 'review_train.csv'), index=False)
        review_test.to_csv(os.path.join('com_cheese_api/resources/data', 'review_test.csv'), index=False)       
