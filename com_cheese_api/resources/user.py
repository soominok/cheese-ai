...
class UserDf:
    ...
    def new(self):
        ...
        this = UserDf.brand_merge_code(this)
        ...
        df = pd.DataFrame(
            {
                ...
                # 'cheese_brand': this.train.cheese_brand,
...
#######################더미변수로?! 여쭤보기~~###############################
    ...
    def brand_merge_code(this) -> object:
        ...
        this.user = pd.merge(this.user, brand_code, left_on = 'cheese_brand', right_on = 'brand', how = 'left')
        return this
